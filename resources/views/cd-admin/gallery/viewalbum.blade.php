...
<section class="content" style="padding: 40px;">
	<div class="row">
    <div>
        <a href="{{url('/album-add')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Image</button></a>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="{{url('deletealbum/'.$ser->id)}}"><button type="button" class="btn btn-outline">Yes</button></a>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
...
<!-- 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <p><strong>Description : </strong>{!!strip_tags($ser->summary)!!}
